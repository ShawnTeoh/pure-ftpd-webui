...
$um_add_presulterror = "ERROR: " . mysqli_error($db);
...
$du_error = "ERROR: " . mysqli_error($db);
...
$wu_add_resulterror = "ERROR: " . mysqli_error($db);
